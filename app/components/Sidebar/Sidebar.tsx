...
export default function Sidebar() {
  const { activeFile, openFile } = useSystemStore();
  ...
  return (
    <div className="w-72 border-r border-border bg-void flex flex-col h-full select-none font-mono text-sm">
      {/* Header */}
      <div className="h-10 flex items-center px-3 border-b border-border bg-void/50 backdrop-blur-md">
        <div className="flex items-center gap-3 text-concrete text-xs">
          ...
          <span className="px-2 py-0.5 text-[10px] font-bold tracking-widest uppercase text-[#379634] border border-[#379634]/40 rounded animate-pulse opacity-60">
            BETA
          </span>
        </div>
      </div>
